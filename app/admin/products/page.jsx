...
// //   const fetchSub = async (catId) => {
// //     const res = await axios.get("/api/admin/subcategories");
// //     setSubcategories(res.data.data.filter(s => s.category._id === catId));
// //   };

// //   useEffect(() => {
// //     fetchProducts();
// //     axios.get("/api/admin/categories").then(res => setCategories(res.data.data));
// //   }, []);
...
// //       {/* FORM */}
// //       <div className="bg-white p-4 border rounded grid grid-cols-2 gap-3 mb-6">
...
// //         <input placeholder="MOQ" value={form.moq}
// //           onChange={e=>setForm({...form,moq:e.target.value})} />

// //         <select value={form.category}
// //           onChange={e=>{
// //             setForm({...form,category:e.target.value});
// //             fetchSub(e.target.value);
// //           }}>
...
// //         <input placeholder="God Name" onChange={e=>setForm({...form,godName:e.target.value})}/>
...
// //         <input placeholder="Finish" onChange={e=>setForm({...form,finish:e.target.value})}/>
...
// //         <input type="file"
// //           onChange={async e=>setThumbnail(await uploadImage(e.target.files[0]))} />

// //         <input type="file" multiple
// //           onChange={async e=>{
// //             const urls=[];
// //             for (let f of e.target.files) urls.push(await uploadImage(f));
// //             setImages(prev=>[...prev,...urls]); // ✅ FIX
// //           }} />

// //         <button onClick={handleSubmit}
// //           className="col-span-2 bg-[#C08237] text-white py-2 rounded">
...
//       {/* ---------- FORM ---------- */}
//       <div className="bg-white border rounded p-4 grid grid-cols-2 gap-3 mb-6">

//         {Object.keys(INITIAL_FORM).map((key) => (
//           key !== "availability" && key !== "productType" && (
//             <input
//               key={key}
...
//           />
//           {thumbnail && (
//             <img src={thumbnail} className="w-24 h-24 mt-2 object-cover" />
//           )}
//         </div>
...
//         <input placeholder="God Name" onChange={e=>setForm({...form,godName:e.target.value})}/>
//         <input placeholder="Color" onChange={e=>setForm({...form,color:e.target.value})}/>
//         <input placeholder="Suitable For" onChange={e=>setForm({...form,suitableFor:e.target.value})}/>
//         <input placeholder="Usage" onChange={e=>setForm({...form,usage:e.target.value})}/>
//         <input placeholder="Posture" onChange={e=>setForm({...form,posture:e.target.value})}/>
//         <input placeholder="Base Shape" onChange={e=>setForm({...form,baseShape:e.target.value})}/>
//         <input placeholder="Finish" onChange={e=>setForm({...form,finish:e.target.value})}/>
//         <input placeholder="Appearance" onChange={e=>setForm({...form,appearance:e.target.value})}/>
//         <input placeholder="Care Instruction" onChange={e=>setForm({...form,careInstruction:e.target.value})}/>
//         <input placeholder="Assembly Required" onChange={e=>setForm({...form,assemblyRequired:e.target.value})}/>
//         <input placeholder="Product Type" onChange={e=>setForm({...form,productType:e.target.value})}/>
...
//       uploadedImages = [...images, ...uploadedUrls];
...
//                 <p className="text-2xl font-bold text-gray-900 mt-1">
//                   ₹{products.length ? Math.round(products.reduce((sum, p) => sum + (p.price || 0), 0) / products.length) : 0}
//                 </p>
//               </div>
...
//                       <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-[#C08237] transition-colors">
...
//                         />
//                       </div>
//                       <p className="text-xs text-gray-500 mt-2">Main product image for listings</p>
//                     </div>
//                     {thumbnail && (
...
//                     Gallery Images
//                   </label>
//                   <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-[#C08237] transition-colors mb-4">
...
//                   className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C08237] focus:border-transparent bg-white"
//                 >
