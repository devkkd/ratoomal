...
//       <h1 className="text-2xl font-bold mb-6">Sub Category Management</h1>

//       {/* FORM */}
//       <div className="bg-white p-4 border rounded mb-6 flex gap-3">
//         <select
//           value={category}
...
//           disabled={loading}
//           className="bg-[#C08237] text-white px-4 rounded flex items-center gap-2"
//         >
//           <Plus size={16} />
//           {editId ? "Update" : "Add"}
//         </button>
