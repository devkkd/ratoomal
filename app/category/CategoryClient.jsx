...
const CategoryPage = () => {
    ...
    // Track site header visibility to shift toolbar + sidebar dynamically
    // Mirrors the same logic as Header.jsx scroll behavior
    const [siteHeaderVisible, setSiteHeaderVisible] = useState(true);
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            if (currentY < 80) {
                setSiteHeaderVisible(true);
            } else if (currentY > lastScrollYRef.current + 8) {
                setSiteHeaderVisible(false);
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#FDFBF7] via-white to-[#FFF9F2]">
            ...
            {/* Page Hero - Collection Title */}
            <section className="bg-gradient-to-r from-white via-[#FFFCF8] to-white border-b border-[#E5DDD5]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-8 mt-2">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
                    ...
                    <aside className="hidden lg:block lg:w-72 shrink-0">
                        <div className={`sticky space-y-4 transition-all duration-300 ${siteHeaderVisible ? 'top-[130px]' : 'top-6'}`}>
