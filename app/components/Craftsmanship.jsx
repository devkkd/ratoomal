...
export default function ArtOfAuthenticity() {
  return (
<section className="w-full bg-[#FCF8F1] pt-16 pb-8 md:py-16 flex flex-col items-center text-center px-4">
 ...
 <div className="max-w-[1200px] mx-auto mt-8 space-y-8">
  ...
  <p className="mona text-[14px] md:text-[16px] leading-[1.9] text-[#2B2B2B] text-center">
