                        ...
                        <div className="mt-3 flex flex-col flex-grow">
                            ...
                            <div className="mt-3 space-y-2 mt-auto">
                                ...
                                <button
                                    ...
                                    className="w-full py-2 my-2 bg-[#C08237] text-white text-xs font-medium rounded-md hover:bg-[#9C774A] transition-colors flex items-center justify-center gap-1"
                                >
