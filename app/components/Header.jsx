...
//         // 3. Fetch categories (using public API)
//         try {
...
//         // 4. Fetch subcategories (using public API)
//         try {
...
//         // 5. Fetch products for search (using public API with limit)
//         try {
...
//             <button className="p-2 border rounded-full border-[#C08237] bg-[#C08237] hover:bg-[#a66f2e] transition-all group relative">
...
//                               className="flex items-center justify-between w-full px-6 py-3 text-sm font-medium text-gray-700 hover:bg-[#FFF6EB] hover:text-[#C08237] transition-all border-b border-gray-100 last:border-0"
//                             >
