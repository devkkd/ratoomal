...
import { ChevronDown, Upload, CheckCircle, AlertCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="space-y-6 lg:sticky lg:top-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-[#1A1A1A] leading-tight">
            Handicraft Export Solutions for Your Business
          </h1>
          <p className="text-gray-600 text-lg max-w-lg leading-relaxed">
           Ratoomal is a reliable handicraft exporter in jaipur, which sells high-quality handcrafted wooden elephant showpieces and exclusive decor and design products to international customers and interior decor brands.
          </p>
        </div>
