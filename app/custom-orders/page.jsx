...
// //                   <select className="w-full p-3 mona bg-white border border-gray-200 rounded-md text-sm appearance-none focus:outline-none focus:ring-1 focus:ring-[#C18E4D]">
...
//         "/api/admin/custom-orders/upload",
//         fd,
...
//       let referenceFiles = [];
//       if (files.length) {
//         referenceFiles = await uploadFiles();
//       }

//       await api.post("/api/admin/custom-orders", {
//         ...formData,
//         referenceFiles,
//       });
...
//                     onChange={handleChange}
//                     className="w-full p-3 mona bg-white border border-gray-200 rounded-md text-sm appearance-none focus:outline-none focus:ring-1 focus:ring-[#C18E4D]"
//                   >
...
//                     onChange={handleChange}
//                     className="w-full p-3 bg-white border border-gray-200 rounded-md text-sm appearance-none focus:outline-none focus:ring-1 focus:ring-[#C18E4D]"
//                   >
...
//                     className="w-full p-3 bg-white border border-gray-200 rounded-md text-sm appearance-none focus:outline-none focus:ring-1 focus:ring-[#C18E4D]"
//                   >
//                     <option value="">Select Product Category Interested In</option>
...
//                 >
//                   <span>{files.length > 0 ? `${files.length} file(s) selected` : "Upload"}</span>
//                   <Upload className="h-4 w-4" />
//                 </button>
//                 <input 
//                   id="fileInput"
