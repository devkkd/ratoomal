...
//   // Fallback images if product images not available
//   const defaultImages = product?.img ? [product.img] : ["/images/products/image 59.png"];
...
//             className="mt-4 px-6 py-2 bg-[#C08237] text-white rounded-lg hover:bg-[#9C774A]"
//           >
//             Back to Category
//           </button>
//         </div>
...
//           <div className="flex flex-col sm:flex-row items-start sm:items-center w-full gap-2 md:gap-0">
//             <p className="text-[#0E0E0E] text-xs sm:text-[10px] md:text-[14px] font-medium tracking-wide mona order-2 sm:order-1 sm:w-auto w-full text-center sm:text-left">
//               {product.category || "Ratoomal's Heritage Collection"}
//             </p>
//             <h1 className="text-lg sm:text-2xl md:text-3xl text-center sm:text-left w-full sm:w-1/2 mx-auto mona font-bold text-[#1a1a1a] order-1 sm:order-2">
//               {product.name}
//             </h1>
...
//             <div className="w-full sm:w-auto">
//               <span className="text-gray-500 mona font-normal">Minimum Order Quantity:</span> 
//               <span className="text-black mona font-bold ml-1">{product.moq || 50} Piece</span>
//             </div>
//             <div className="text-base mona sm:text-md md:text-lg w-full sm:w-1/2 text-center sm:text-center font-black text-[#1a1a1a]">
//               ₹ {product.price || "999"}/Piece
//             </div>
//             <div className="flex flex-wrap items-center gap-3 sm:gap-4 md:gap-8 w-full sm:w-auto justify-center sm:justify-start">
//               <div className="flex gap-2 sm:gap-3 w-full sm:w-auto justify-center">
//                 <button className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-2 sm:py-3 border border-gray-300 rounded-full bg-white text-xs font-semibold hover:bg-gray-50 transition flex-shrink-0">
...
//                 <p className="text-xs mona md:text-[13px] text-gray-700 leading-relaxed font-medium md:leading-[1.8]">
//                   {product.longDescription || product.description || "This beautifully crafted product is perfect for home decor, gifting, and more. Discover the best quality product with various sizes and styles to meet your specific needs."}
//                 </p>
//               </div>
//               <hr className='my-3 md:my-4 text-[#D7CEC2]'/>
//               <div className="mt-2 md:mt-3 space-y-2 md:space-y-3">
...
//                       <p>• Perfect for home and office decor</p>
//                       <p>• Makes an excellent gift item</p>
//                       <p>• Available in various sizes</p>
//                       <p>• Artisan crafted with attention to detail</p>
//                     </>
//                   )}
//                 </div>
//               </div>
...
//               <div className="space-y-1.5">
//                 <p className="text-xs md:text-[14px] mona">
//                   <span className="font-bold mona border-b border-[#bf8e44] pb-0.5">Wholesale Prices:</span> Enjoy significant cost savings with our bulk purchasing options.
//                 </p>
//                 <p className="text-xs md:text-[14px] mona">
//                   <span className="font-bold mona border-b border-[#bf8e44] pb-0.5">Customization Options:</span> We offer customization for bulk orders.
//                 </p>
//                 <p className="text-xs md:text-[14px] mona">
//                   <span className="font-bold border-b mona border-[#bf8e44] pb-0.5">Flexible Purchase Options:</span> Whether you need to buy in bulk online or make a single large purchase.
//                 </p>
//               </div>
//             </div>
//           </div>
